//! Optimized lock-free metrics collection system for FluxMQ
//!
//! Performance improvements:
//! - Lock-free atomic operations with proper memory ordering
//! - Eliminated RwLock contention in hot paths
//! - Cache-line aligned structures to prevent false sharing
//! - Minimal overhead in message processing paths
...
impl ThroughputMetrics {
    ...
    pub fn record_produced(&self, count: u64, bytes: u64) {
        // Use Release ordering for writes to ensure visibility
